...
test_image_list = '/Users/sal/projects/BalchLab/Covid-19/VSP_emb_28g_CoV2_spritelist.tsv' # path to the image list
with open(test_image_list, 'r') as f:
    test_images = f.readlines()
    test_images = map(str.strip, test_images)

grid = 28#int(math.sqrt(len(test_images))) + 1
image_height = 140 #int(8192 / grid)         # tensorboard supports sprite images up to 8192 x 8192
image_width = 140 #int(8192 / grid)
...
big_image.save('sprite_image_28g_onerow.png')#, transparency=0)
